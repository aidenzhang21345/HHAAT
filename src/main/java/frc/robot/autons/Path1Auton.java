...
public class Path1Auton extends SequentialCommandGroup {
    public Path1Auton(Drivetrain drivetrain) {
        addCommands( // assume the robot is facing out the exit of the base
            new DriveDistance(1.0, 18.0, drivetrain), // double speed, double inches, Drivetrain drive
            new TurnDegrees(1.0, -90.0, drivetrain), // 1 double speed, double deg, double inches, Drivetrain drivetrain

            new DriveDistance(1.0, 11.0, drivetrain),
            new TurnDegrees(1.0, 90.0, drivetrain), // 2

            new DriveDistance(1.0, 16.0, drivetrain),
            new TurnDegrees(1.0, 90.0, drivetrain), // 3

            new DriveDistance(1.0, 12.0, drivetrain),
            new TurnDegrees(1.0, 70.0, drivetrain), // 4

            new DriveDistance(1.0, 9.0, drivetrain) //5
